...
El texto puede ser \textbf{Texto} (\textbackslash textbf), \textsc{Texto} (\textbackslash textsc), \textit{Texto} (\textbackslash textit) o cualquier combinación de ellas. No todas las tipografías tienen todas las combinaciones.
